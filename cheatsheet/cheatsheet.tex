...
\begin{multicols}{4}
  ...
  \textbf{$\Delta$T conversion: } $\displaystyle \frac{1K}{1.8F}$ and $\displaystyle \frac{1^\circ C}{1^\circ F}$ 
  ...
  determine K at a certain temperature (two point form) $\rightarrow$ \textbf{van't hoff equation} (see formula sheet)
  ...
  \begin{itemize}
    ...
    \item others \textit{USUALLY} just go check group number
  \end{itemize}
  ...
  $\displaystyle \eta = \frac{\text{charge used}}{\text{charge supplied}} \times 100\% = \frac{\text{actual mass}}{\text{theoretical mass}} \times 100\%$

  \subsection{standard cell potential}

  \textbf{standard conditions:} 1.0 M for dissolved species, 1 bar for gases, 25$^\circ$C
  ...
  \begin{framed}
    in the nernst equation use $n=$ \# of electrons transferred, $R = 8.314$ L$\cdot$J/(mol$\cdot$K)
  \end{framed}

  \textbf{nernst @ 25$^\circ$C:}
  $\displaystyle E_{\text{cell}} = E^\circ_{\text{cell}} - \frac{0.0592}{n}\log Q$

  \textbf{concentration cell:} same material at anode and cathode. \textbf{higher concentration} acts as \textbf{cathode}, $E_{\text{cell}} = 0$
  ...
  \begin{itemize}
    ...
    $\displaystyle 0 = E^\circ_{\text{cell}} - \frac{RT}{nF}\ln K\implies\boxed{\displaystyle K = \exp\left(\frac{E^\circ_{\text{cell}}nF}{RT}\right)}$
